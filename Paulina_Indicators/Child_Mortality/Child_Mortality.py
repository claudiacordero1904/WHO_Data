...
def find_all_topic_indicators(ind_df):
    search_words = ['Child mortality', 'under-five', 'neonatal', 'infant mortality', 'stillbirth', 'adolescent mortality']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "child_mortality_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "child_mortality_all_wide.csv")
