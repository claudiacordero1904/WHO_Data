...
def find_all_topic_indicators(ind_df):
    search_words = ['Violence prevention', 'child protection', 'medico-legal', 'dating violence', 'life-skills', 'home-visiting', 'youth violence', 'elder abuse']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "violence_prevention_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "violence_prevention_all_wide.csv")
