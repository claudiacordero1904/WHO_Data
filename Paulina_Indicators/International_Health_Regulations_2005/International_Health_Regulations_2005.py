...
def find_all_topic_indicators(ind_df):
    search_words = ['International Health Regulations', 'IHR', 'SPAR', 'JEE']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "international_health_regulations_2005_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "international_health_regulations_2005_all_wide.csv")
