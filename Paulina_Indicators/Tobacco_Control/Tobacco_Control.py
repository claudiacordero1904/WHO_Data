...
def find_all_topic_indicators(ind_df):
    search_words = ['Tobacco', 'MPOWER', 'cigarettes', 'ENDS', 'heated tobacco', 'smokeless', 'tobacco tax']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "tobacco_control_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "tobacco_control_all_wide.csv")
