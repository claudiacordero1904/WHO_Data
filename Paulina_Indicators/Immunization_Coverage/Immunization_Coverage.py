...
def find_all_topic_indicators(ind_df):
    search_words = ['Immunization', 'immunisation', 'coverage', 'HepB3', 'DTP3', 'MCV1', 'MCV2', 'Pol3', 'PCV3', 'Hib3', 'RotaC', 'PAB']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "immunization_coverage_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "immunization_coverage_all_wide.csv")
