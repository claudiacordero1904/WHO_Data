...
def find_all_topic_indicators(ind_df):
    search_words = ['Mental health', 'psychiatrists', 'psychologists', 'mental hospitals', 'suicide', 'outpatient', 'community residential']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "mental_health_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "mental_health_all_wide.csv")
