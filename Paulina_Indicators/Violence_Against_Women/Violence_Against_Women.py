...
def find_all_topic_indicators(ind_df):
    search_words = ['Violence against women', 'intimate partner violence', 'non-partner sexual violence', 'IPV']
...
def save_outputs(topic_long, topic_wide):
    ...
    topic_long.to_csv(outdir / "violence_against_women_all_long.csv", index=False)
    topic_wide.to_csv(outdir / "violence_against_women_all_wide.csv")
